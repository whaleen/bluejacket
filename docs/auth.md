...
> **Warning:** This authentication implementation is **insecure by design**. Do **not** use in production. This is purely for prototyping/testing.
...
**Perfectly fine for prototype mode.**
