...
**Total Pages Documented**: 30
**Pages with Data Export**: 8
...
1. **Before exploring**: Check if page is already documented here
...
4. **External links**: Note if page opens in new tab or different domain
...
- **New Exports Found**: 8
- **Issues Encountered**:
  - Returns Receiving opens in new tab (not fully documented)
  - PAT external domain caused script error
  - Some pages (Inventory Report, Scrap) have incomplete URL documentation
- **Next Steps**: Download sample exports to document exact field schemas
